...
if(isset($_POST["Donation_id"]) && !empty($_POST["Donation_id"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        // Set parameters
        $param_id = trim($_POST["Donation_id"]);
                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        <div class="alert alert-danger fade-in">
                            <input type="hidden" name="Donation_id" value="<?php echo trim($_GET["Donation_id"]); ?>"/>
                            <p>Are you sure you want to delete this record?</p><br>
                            <p>
                                <input type="submit" value="Yes" class="btn btn-danger">
                                <a href="donations-index.php" class="btn btn-secondary">No</a>
                            </p>
                        </div>
                    </form>
                </div>
